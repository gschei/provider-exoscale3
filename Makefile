...
PROJECT_NAME ?= provider-exoscale3
PROJECT_REPO ?= github.com/gschei/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 0.54.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-exoscale
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-exoscale_v0.54.1
...
xpkg.build.provider-exoscale3: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/exoscale3s/01-delete.yaml.tmpl.
